...
async def on_ready():
  ...
  await client.change_presence(status=discord.Status.online, activity=discord.Game('How to kill Humanity (fast)'))
@client.event
...
async def whoami(ctx):
  ...
  await client.change_presence(status=discord.Status.online, activity=discord.Game('Collecting Names'))
  
@client.command()
async def hi(ctx):
  username = ctx.message.author.name
  await ctx.reply(f'Hello {username}!')
  await client.change_presence(status=discord.Status.online, activity=discord.Game('greetings'))
  return
@client.command()
async def randomnr(ctx):
  randomnr = random.randrange(1000000)
  await ctx.reply(f'Deine Nummer ist {randomnr}')
  await client.change_presence(status=discord.Status.online, activity=discord.Game('meming'))
  return
#memes
@client.command(pass_context=True)
async def willi(ctx):
    await ctx.send(file=discord.File('willi.jpg'))
@client.command(pass_context=True)
async def mcqueen(ctx):
    await ctx.send(file=discord.File('mcqueen.png'))
    await client.change_presence(status=discord.Status.online, activity=discord.Game('meming'))
@client.command(pass_context=True)
async def depressed(ctx):
    await ctx.send(file=discord.File('depressed.jpg'))
@client.command(pass_context=True)
async def bitches(ctx):
    await ctx.send(file=discord.File('bitches.jpg'))
@client.command(pass_context=True)
async def catjam(ctx):
    await ctx.send(file=discord.File('catjam.gif'))
@client.command(pass_context=True)
async def party(ctx):
    await ctx.send(file=discord.File('catjam.gif'))
@client.command(pass_context=True)
async def forsenpls(ctx):
    await ctx.send(file=discord.File('forsenpls.gif'))
@client.command(pass_context=True)
async def crybaby(ctx):
    await ctx.send(file=discord.File('crybaby.png'))
@client.command(pass_context=True)
async def trolled(ctx):
    await ctx.send(file=discord.File('jebaited.gif'))
@client.command(pass_context=True)
async def cool(ctx):
    await ctx.send(file=discord.File('cool.gif'))
@client.command(pass_context=True)
async def sadpepe(ctx):
    await ctx.send(file=discord.File('sadpepe.gif'))
